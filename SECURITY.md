...
If you discover a security vulnerability in the CapSkip PHP SDK, please report it responsibly.
...
This policy covers the `capskip/capskip` PHP package in this repository.
